...
public class UserManagerImpl implements UserManager {
     ...
     */
    public LopBxUser login(String userId, String password) {
     ...
     * @return 新的用户信息
     */
    public void register(LopBxUser user) throws DuplicatedUserException {
        LopBxUser dupuser = userDao.getUserById(user.getUserId());
     ...
     * @return 新的用户信息
     */
    public void update(LopBxUser user) {
     ...
     * @return 指定id的用户
     */
    public LopBxUser getUser(String userId) {
