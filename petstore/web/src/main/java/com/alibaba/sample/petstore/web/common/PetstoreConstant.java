...
public interface PetstoreConstant {
    ...
    /** 在session中保存application order对象的key。 */
    String LOP_ORDER_KEY = "lopOrder";
    ...
    /** 登录ST组员URL的名字。 */
    String LOP_ST_MEMBER_HOME_LINK = "lopStMemberHomeLink";
    
    /** 登录ST组长URL的名字。 */
    String LOP_ST_HEADMAN_LINK = "lopStHeadmanLink";
    
    /** 登录ST财务URL的名字。 */
    String LOP_ST_FINANCE_LINK = "lopStFinanceLink";
    
    /** 登录ST财务URL的名字。 */
    String LOP_ST_GROUPDETAIL_LINK = "lopStGroupDetailLink";
    
    /** 查看ST组员申请状态信息URL的名字。 */
    String LOP_ST_MEMBER_APLICATION_STATUS_LINK = "lopStMemberAplicationStatusLink";
}
