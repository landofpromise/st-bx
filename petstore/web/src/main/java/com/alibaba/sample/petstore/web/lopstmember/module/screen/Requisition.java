...
public class Requisition {    
    ...
    public void execute(/*HttpSession session, */Context context, @Param(name="orderId") String orderId, ParameterParser params) throws Exception {
